...
from tcs_garr.main import logger, discover_commands
...
def discover_extra_commands(args):
    command_classes = {}
    package = "tcs_sissa"
...
def main(argv=None):
    ...
    parser = argparse.ArgumentParser(
        prog="tcs-sissa", description="Harica Certificate Manager with SISSA customizations"
    )
    ...
    command_instances = discover_extra_commands(None)
    ...
    command_instances = {}
    command_instances.update(discover_extra_commands(args))
